  ...
  ],
  {
    variants: {
      variant: {
        ...
        warning: 'warning border-yellow-500 bg-yellow-500 text-white',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      'absolute right-2 top-2 rounded-md p-1 transition-all duration-200 focus:outline-none focus:ring-2',
      'text-foreground/50 hover:bg-black/10 hover:text-foreground',
      'group-[.success]:text-white/80 group-[.success]:hover:bg-black/15 group-[.success]:hover:text-white',
      'group-[.warning]:text-white/80 group-[.warning]:hover:bg-black/15 group-[.warning]:hover:text-white',
      `group-[.destructive]:text-red-300 group-[.destructive]:hover:bg-white/10 group-[.destructive]:hover:text-red-50
