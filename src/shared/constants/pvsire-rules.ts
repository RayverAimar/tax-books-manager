...
export const PVSIRE_CP_FEC_MENOR_PERIODO = new Set([
  '01', '08', '23', '30', '34', '42', '50', '52', '53', '54'
]);
...
export const PVSIRE_CURRENCY_CODES = new Set([
  ...
  'TMT','UGX','UAH','AED','USN','UYU','UYI','UYW','UZS','VUV','VES','VND','YER','ZMW',
  'ZWL','XBA','XBB','XBC','XBD','XTS','XXX','XAU','XPD','XPT','XAG'
]);
